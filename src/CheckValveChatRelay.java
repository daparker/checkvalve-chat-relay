...
public class CheckValveChatRelay
{
    ...
    static ByteBuffer messageData = ByteBuffer.allocate(1024);
    ...
    private static class ClientListener implements Runnable
    {
        ...
        private void runClientListener() throws Exception
        {
            ...
            for(;;)
            {
                ...
                //    [1]: IP of the game server from which this client wants chat messages
                //    [2]: Port of the game server from which this client wants chat messages
                //
        ...
        public void run()
        {
            ...
            for(;;)
            {
                try
                {
                    ...
                    logger.writeln( "[STATS] Chat messages relayed: " + chatPackets );
