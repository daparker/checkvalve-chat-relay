 ...
 *
 * DESCRIPTION:
 * Control program for the CheckValve Chat Relay.
 *
 * AUTHOR:
 * Dave Parker
 *
...
package com.github.daparker.checkvalve.chatrelayctl;
...
public class ChatRelayCtl
{
    ...
    private static final String IDENTITY_STRING = "CheckValve Chat Relay Control " + PROGRAM_VERSION;
    ...
    public static void main(String args[]) throws InterruptedException
    {
        ...
        try
        {
            ...
            jarFile = parentDir.getCanonicalPath() + fs + "lib" + fs + "checkvalvechatrelay.jar";
            configFile = parentDir.getCanonicalPath() + fs + "checkvalvechatrelay.properties";
            minHeap = "8m";
            maxHeap = "16m";
            debugHost = "localhost";
            debugPort = "1044";
    ...
    private static void startChatRelay()
    {
        File f;
    ...
    private static void sendCtl( byte ctl )
    {
        ...
        try
        {
            ...
            if( reqType == CTL_PTYPE_STATUS_RESPONSE )
            {
                ...
                long chatPackets = inBuffer.getLong();
                ...
                System.out.println();
                System.out.println( "CheckValve Chat Relay is running." );
                System.out.println();
                ...
                System.out.println( "  Chat packets relayed: " + chatPackets );
            ...
            else if( reqType == CTL_PTYPE_SHUTDOWN_RESPONSE )
            {
                ...
                if( response == (byte)0x00 )
                    System.out.println( "CheckValve Chat Relay is shutting down.");
                else
